...
class ActionButton extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      buttonColor: this.props.buttonColor || '#f0f0f0',
      buttonTextColor: this.props.buttonTextColor || '#f0f0f0',
  ...
  _renderButton() {
    let btnSize = this.state.size / 1.1;
    return (
          ...
          <Animated.View 
            style={[styles.btn, {
              ...
              backgroundColor: this.state.anim.interpolate({
                inputRange: [0, 1],
                outputRange: [this.state.buttonColor, '#f0f0f0']
              }),
              transform: [
                {
